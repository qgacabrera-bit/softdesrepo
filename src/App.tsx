...
function App() {
  ...
  const [isSidebar, setIsSidebar] = useState(window.scrollY > 140);
  ...
  useEffect(() => {
    const handleScroll = () => {
      setIsSidebar(window.scrollY > 140);
    };
  ...
  if (isDiagnosisPage) {
    return (
      <LayoutShell>
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-4 lg:px-8">
